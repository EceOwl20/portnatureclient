...
const MeetingReverseSection = ({image,header,text,span}) => {
  return (
    <div id='perge' className='flex w-full justify-center items-center my-20'>
      <div className='flex flex-col-reverse lg:flex-row-reverse w-[90%] justify-center md:justify-between items-center'>
        <img src={image.firebaseUrl} alt={image.altText} className='w-[95%] lg:w-[60%] mt-4'/>
        <div className='flex flex-col lg:w-[35%] items-center md:items-start lg:items-end justify-center md:justify-start text-center md:text-start w-[95%]'>
