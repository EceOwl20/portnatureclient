...
const Section3 = ({header,text,image, links, linksText}) => {
  return (
    <div className='flex justify-center items-center'>
        <div className='flex flex-col lg:flex-row-reverse gap-10 lg:gap-24 mt-12 mb-12 max-w-[1920px] items-center justify-center'>
        ...
        <div className='flex flex-col w-[85%] lg:w-4/12 gap-7 relative items-center justify-center text-center'>
            <h2 className='text-start flex font-lora text-[25px] lg:text-[40px] font-medium leading-normal mb-4'>
                {header}
            </h2>
                <div className='flex w-5/12 mt-6 mb-4 absolute top-8 lg:top-12 left-1/2 -translate-x-1/2 lg:-left-12'>
