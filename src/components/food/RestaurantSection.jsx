...
const RestaurantSection = ({image,header,text,span,buttonText, buttonLink}) => {
  return (
    <section className='flex w-screen h-auto my-10 items-center justify-center'>
      <div className='flex w-[100%] lg:w-[90%] flex-col lg:flex-row items-center justify-center gap-5 lg:gap-0'>
        <img src={image.firebaseUrl} alt='img' width={988} height={560} className='flex min-h-[360px] w-full sm:w-[95%] md:w-[90%] lg:w-[60%] object-cover'/>
